...
trait HasTerms
{
  ...
  // TODO - This method might be removable in favor of Timber::get_terms()
  /**
   * @deprecated 2.0
   * 
  ...
  public static function get_all_grouped_by_term(
    ...
    trigger_error('[ Conifer ] Post::get_all_grouped_by_term() is deprecated in Conifer 1.0.0. Use Timber::get_terms() with Class Maps instead. https://timber.github.io/docs/v2/guides/terms/#querying-terms');
