...
./vendor/bin/phpdoc-md generate /app/lib/Conifer/AjaxHandler > docs/reference/ajaxhandler.md
...
#./vendor/bin/phpdoc-md generate /app/lib/Conifer/Post > docs/reference/post.md
...
#./vendor/bin/phpdoc-md generate /app/lib/Conifer/AcfSearch.php > /app/docs/reference/acf-search.md
#./vendor/bin/phpdoc-md generate /app/lib/Conifer/Site.php > /app/docs/reference/site.md